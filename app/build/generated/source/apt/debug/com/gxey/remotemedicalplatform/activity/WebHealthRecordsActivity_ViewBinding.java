...
public class WebHealthRecordsActivity_ViewBinding<T extends WebHealthRecordsActivity> implements Unbinder {
  protected T target;

  @UiThread
  public WebHealthRecordsActivity_ViewBinding(T target, View source) {
    this.target = target;
