...
public class ActivityHeathDangAn_ViewBinding<T extends ActivityHeathDangAn> implements Unbinder {
  protected T target;

  @UiThread
  public ActivityHeathDangAn_ViewBinding(T target, View source) {
    this.target = target;
