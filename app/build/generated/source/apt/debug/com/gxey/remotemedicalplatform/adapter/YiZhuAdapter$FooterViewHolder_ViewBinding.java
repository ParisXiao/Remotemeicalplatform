...
public class YiZhuAdapter$FooterViewHolder_ViewBinding<T extends YiZhuAdapter.FooterViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public YiZhuAdapter$FooterViewHolder_ViewBinding(T target, View source) {
    this.target = target;
