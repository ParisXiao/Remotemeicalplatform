...
public class HealthBGAdapter$FooterViewHolder_ViewBinding<T extends HealthBGAdapter.FooterViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public HealthBGAdapter$FooterViewHolder_ViewBinding(T target, View source) {
    this.target = target;
