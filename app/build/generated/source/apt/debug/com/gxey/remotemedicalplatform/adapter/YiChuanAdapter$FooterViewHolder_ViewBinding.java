...
public class YiChuanAdapter$FooterViewHolder_ViewBinding<T extends YiChuanAdapter.FooterViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public YiChuanAdapter$FooterViewHolder_ViewBinding(T target, View source) {
    this.target = target;
