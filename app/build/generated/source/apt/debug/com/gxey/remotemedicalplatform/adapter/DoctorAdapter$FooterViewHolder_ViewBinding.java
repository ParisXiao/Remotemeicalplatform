...
public class DoctorAdapter$FooterViewHolder_ViewBinding<T extends DoctorAdapter.FooterViewHolder> implements Unbinder {
  protected T target;

  @UiThread
  public DoctorAdapter$FooterViewHolder_ViewBinding(T target, View source) {
    this.target = target;
