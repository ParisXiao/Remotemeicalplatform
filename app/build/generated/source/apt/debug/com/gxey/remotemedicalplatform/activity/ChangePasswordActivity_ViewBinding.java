...
public class ChangePasswordActivity_ViewBinding<T extends ChangePasswordActivity> implements Unbinder {
  ...
  public ChangePasswordActivity_ViewBinding(T target, View source) {
    ...
    target.pass_number2 = Utils.findRequiredViewAsType(source, R.id.re_number11, "field 'pass_number2'", TextView.class);
    target.back = Utils.findRequiredViewAsType(source, R.id.back, "field 'back'", ImageView.class);
    target.linear = Utils.findRequiredViewAsType(source, R.id.ll_re_number2, "field 'linear'", LinearLayout.class);
  }
