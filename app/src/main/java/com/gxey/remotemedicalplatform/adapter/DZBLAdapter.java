...
public class DZBLAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {



    private LayoutInflater mInflater;
    private Context context;
    private List<DianZiBLBean> list = new ArrayList<>();
    ...
    public DZBLAdapter(Context context, List<DianZiBLBean> list) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ...
            }else  if (list.get(position).getPeriod().equals("2")){
    ...
    public void AddHeaderItem(List<DianZiBLBean> items) {
        list.addAll(0, items);
        notifyDataSetChanged();
    }

    public void AddFooterItem(List<DianZiBLBean> items) {
        list.addAll(items);
        notifyDataSetChanged();
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
            itemView.setOnClickListener(DZBLAdapter.this);
        }
