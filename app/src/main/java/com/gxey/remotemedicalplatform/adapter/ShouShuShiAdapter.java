...
public class ShouShuShiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {



    private LayoutInflater mInflater;
    private Context context;
    private List<JiWangShiBean.SurgeryBean> list=new ArrayList<>();
    ...
    public ShouShuShiAdapter(Context context, List<JiWangShiBean.SurgeryBean> list) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ((MyViewHolder) holder).itemResult.setText("手术结果");
            ((MyViewHolder) holder).itemTitle.setText("手术数据");
            ((MyViewHolder) holder).itemNameText.setText("手术名称");
            ((MyViewHolder) holder).itemTime.setText("手术时间");
            ((MyViewHolder) holder).itemJbName.setText(list.get(position).getOperativeName());
            ((MyViewHolder) holder).itemJbTime.setText(list.get(position).getOperationTime());
             ((MyViewHolder) holder).itemJbZl.setText(list.get(position).getDiagnosticresults());
