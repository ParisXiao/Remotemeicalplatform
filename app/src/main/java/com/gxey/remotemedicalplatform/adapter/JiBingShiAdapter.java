...
public class JiBingShiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {



    private LayoutInflater mInflater;
    private Context context;
    private List<JiWangShiBean.HistoryOfDiseaseBean> list=new ArrayList<>();
    ...
    public JiBingShiAdapter(Context context, List<JiWangShiBean.HistoryOfDiseaseBean> list) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ((MyViewHolder) holder).itemJbName.setText(list.get(position).getNameofThedisease());
            ((MyViewHolder) holder).itemJbTime.setText(list.get(position).getTimeofdiagnosis());
             ((MyViewHolder) holder).itemJbZl.setText(list.get(position).getIsitcured());
