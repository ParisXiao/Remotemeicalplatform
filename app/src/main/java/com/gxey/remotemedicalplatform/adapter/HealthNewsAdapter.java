...
public class HealthNewsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {


    @BindView(R.id.item_type5_img)
    ImageView itemType5Img;
    @BindView(R.id.item_type5_title)
    TextView itemType5Title;
    @BindView(R.id.item_type5_content)
    TextView itemType5Content;
    ...
    public HealthNewsAdapter(Context context, List<HomeNewsBen> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ITEM) {
            View itemView = mInflater.inflate(R.layout.item_home_type5, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ((MyViewHolder) holder).itemType5Title.setText(list.get(position).getTitle());
            ImageUtils.load(context,list.get(position).getImgUrl(), ((MyViewHolder) holder).itemType5Img);
            ((MyViewHolder) holder).itemType5Content.setText(list.get(position).getContent());
