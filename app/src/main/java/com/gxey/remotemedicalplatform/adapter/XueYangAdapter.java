...
public class XueYangAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {



    private LayoutInflater mInflater;
    private Context context;
    private List<XueYangBean> list = new ArrayList<>();
    private List<XueYangBean> listLast = new ArrayList<>();
    ...
    public XueYangAdapter(Context context, List<XueYangBean> list) {
...
//            }
    ...
    public void AddHeaderItem(List<XueYangBean> items) {
        list.addAll(0, items);
        notifyDataSetChanged();
    }

    public void AddFooterItem(List<XueYangBean> items) {
        list.addAll(items);
        notifyDataSetChanged();
    }
