...
public class MZBLAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {



    private LayoutInflater mInflater;
    private Context context;
    private List<MZBLBean> list = new ArrayList<>();
    ...
    public MZBLAdapter(Context context, List<MZBLBean> list) {
    ...
    public void AddHeaderItem(List<MZBLBean> items) {
        list.addAll(0, items);
        notifyDataSetChanged();
    }

    public void AddFooterItem(List<MZBLBean> items) {
        list.addAll(items);
        notifyDataSetChanged();
    }
    ...
    class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
            itemView.setOnClickListener(MZBLAdapter.this);
        }
