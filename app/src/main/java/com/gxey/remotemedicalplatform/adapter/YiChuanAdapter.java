...
public class YiChuanAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {


    private LayoutInflater mInflater;
    private Context context;
    private List<YiChuanBean> yiChuanBeen = new ArrayList<>();
    ...
    public YiChuanAdapter(Context context, List<YiChuanBean> yiChuanBeen) {
        this.context = context;
        this.yiChuanBeen = yiChuanBeen;
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ((MyViewHolder) holder).itemYichuanYcname.setText(yiChuanBeen.get(position).getYi_name());
            ((MyViewHolder) holder).itemYichuanTime.setText(yiChuanBeen.get(position).getYi_time());
    ...
    public void AddHeaderItem(List<YiChuanBean> items) {
        yiChuanBeen.addAll(0, items);
        notifyDataSetChanged();
    }

    public void AddFooterItem(List<YiChuanBean> items) {
        yiChuanBeen.addAll(items);
        notifyDataSetChanged();
    }
