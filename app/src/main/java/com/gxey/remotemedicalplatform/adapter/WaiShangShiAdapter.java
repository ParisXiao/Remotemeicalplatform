...
public class WaiShangShiAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {



    private LayoutInflater mInflater;
    private Context context;
    private List<JiWangShiBean.TraumaBean> list=new ArrayList<>();
    ...
    public WaiShangShiAdapter(Context context, List<JiWangShiBean.TraumaBean> list) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof MyViewHolder) {
            ((MyViewHolder) holder).itemResult.setText("外伤描述");
            ((MyViewHolder) holder).itemTitle.setText("外伤数据");
            ((MyViewHolder) holder).itemNameText.setText("外伤名称");
            ((MyViewHolder) holder).itemTime.setText("受伤时间");
            ((MyViewHolder) holder).itemJbName.setText(list.get(position).getNameoftrauma());
            ((MyViewHolder) holder).itemJbTime.setText(list.get(position).getTraumaTime());
             ((MyViewHolder) holder).itemJbZl.setText(list.get(position).getDes());
