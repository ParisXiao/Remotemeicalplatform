...
import com.gxey.remotemedicalplatform.adapter.TiWenAdapter;
...
public class FragmentTiWen extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        recyclerView.setAdapter(adapter = new TiWenAdapter(getActivity(), list));
    }
        ...
        Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                if (MyHttpHelper.isConllection( getActivity())) {
                    ...
                    String result = MyHttpHelper.GetMessage( getActivity(), UrlConfig.SelTemperature, key, map);
...
//        initLoadMoreListener();
        ...
        adapter.setOnItemClickListener(new TiWenAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onClick(View view, TiWenAdapter.ViewName viewName, int position) {
