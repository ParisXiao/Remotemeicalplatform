...
import com.gxey.remotemedicalplatform.adapter.XueYangAdapter;
import com.gxey.remotemedicalplatform.bean.XueYangBean;
...
public class FragmentXueYang extends BaseFragment {
    ...
    Unbinder unbinder;
    private XueYangAdapter adapter;
    private List<XueYangBean> list;
    ...
    protected void initView(View view) {
        ...
        recyclerView.setAdapter(adapter = new XueYangAdapter(getActivity(), list));
    }
...
//        initLoadMoreListener();
        ...
        adapter.setOnItemClickListener(new XueYangAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onClick(View view, XueYangAdapter.ViewName viewName, int position) {
