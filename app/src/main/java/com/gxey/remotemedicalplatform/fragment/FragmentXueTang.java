...
import com.gxey.remotemedicalplatform.adapter.XueTangAdapter;
...
public class FragmentXueTang extends BaseFragment {
    ...
    protected void initView(View view) {
        ...
        recyclerView.setAdapter(adapter = new XueTangAdapter(getActivity(), list));
    }
        ...
        Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                if (MyHttpHelper.isConllection( getActivity())) {
                    ...
                    String result = MyHttpHelper.GetMessage( getActivity(), UrlConfig.SelBloodTang, key, map);
...
//        initLoadMoreListener();
        ...
        adapter.setOnItemClickListener(new XueTangAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onClick(View view, XueTangAdapter.ViewName viewName, int position) {
