...
public class FragmentShouShu extends BaseFragment {
    ...
    Unbinder unbinder;
    private ShouShuShiAdapter adapter;
    ...
    protected void initView(View view) {
        ...
        recyclerView.setAdapter(adapter = new ShouShuShiAdapter(getActivity(), list));
    }
...
//                                成功
                                ...
                                if (jsonArray.length()>0) {
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        JiWangShiBean.SurgeryBean Bean =new JiWangShiBean.SurgeryBean();
                                        JSONObject temp = (JSONObject) jsonArray.get(i);
                                        Bean.setId(temp.getString("Id"));
                                        Bean.setOperativeName(temp.getString("OperativeName"));
                                        Bean.setOperationTime(temp.getString("OperationTime"));
                                        Bean.setDiagnosticresults(temp.getString("Diagnosticresults"));
...
//        initLoadMoreListener();
        ...
        adapter.setOnItemClickListener(new ShouShuShiAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onClick(View view, ShouShuShiAdapter.ViewName viewName, int position) {
