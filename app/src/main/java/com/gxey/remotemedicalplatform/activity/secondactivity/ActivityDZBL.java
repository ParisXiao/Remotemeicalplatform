...
import com.gxey.remotemedicalplatform.adapter.DZBLAdapter;
import com.gxey.remotemedicalplatform.adapter.DZBLAdapter;
...
public class ActivityDZBL extends BaseActivity implements View.OnClickListener {
    ...
    private DZBLAdapter adapter;
    private List<DianZiBLBean> list;
    ...
    protected void initView() {
        ...
        recyclerViewFenzhen.setAdapter(adapter = new DZBLAdapter(this,list));
        //绑定
    }
    ...
    private void getData() {
        ...
        Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                if (MyHttpHelper.isConllection(ActivityDZBL.this)) {
                    String[] key = new String[]{};
                    Map<String, String> map = new HashMap<String, String>();
                    String result = MyHttpHelper.GetMessage(ActivityDZBL.this, UrlConfig.SelElectronicMedicalRecord, key, map);
...
//                                成功
                                ...
                                if (jsonArray.length() > 0) {
                                    for (int i = 0; i < jsonArray.length(); i++) {
                                        DianZiBLBean Bean = new DianZiBLBean();
                                        ...
                                        Bean.setAssistant(temp.getString("Assistant"));
                                        list.add(Bean);
            ...
            public void onNext(Integer integer) {
                switch (integer) {
                    ...
                    case 2:
                        ...
                        ToastUtils.s(ActivityDZBL.this, msg);
                        break;
                    case 3:
                        swipeFenzhen.setRefreshing(false);
                        adapter.notifyDataSetChanged();
                    ...
                    case 4:
                        swipeFenzhen.setRefreshing(false);
                        ToastUtils.s(ActivityDZBL.this, msg);
                        Intent intent = new Intent(ActivityDZBL.this, LoginActivity.class);
...
//        initLoadMoreListener();
        ...
        adapter.setOnItemClickListener(new DZBLAdapter.OnRecyclerViewItemClickListener() {
            @Override
            public void onClick(View view, DZBLAdapter.ViewName viewName, int position) {
                if (viewName== DZBLAdapter.ViewName.ITEM){
                    Intent intent=new Intent(ActivityDZBL.this,ActivityDZDetails.class);
                    intent.putExtra("DZBL",list.get(position));
                    startActivity(intent);
