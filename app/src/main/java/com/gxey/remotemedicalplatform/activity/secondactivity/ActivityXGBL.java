...
public class ActivityXGBL extends BaseActivity implements View.OnClickListener {
    ...
    private void initLoad() {
        ...
        emptyLayoutFenzhen.setOnButtonClick(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                emptyLayoutFenzhen.showLoading(ActivityXGBL.this);
                //重新加载数据
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void getData() {
        ...
        Observable.create(new Observable.OnSubscribe<Integer>() {
            ...
            public void call(Subscriber<? super Integer> subscriber) {
                if (MyHttpHelper.isConllection(ActivityXGBL.this)) {
                    String[] key = new String[]{"type"};
                    Map<String, String> map = new HashMap<String, String>();
                    map.put("type","2");
                    String result = MyHttpHelper.GetMessage(ActivityXGBL.this, UrlConfig.SelCorrelationHospitalExhort, key, map);
            ...
            public void onNext(Integer integer) {
                switch (integer) {
                    ...
                    case 2:
                        ...
                        ToastUtils.s(ActivityXGBL.this, msg);
                        break;
                    case 3:
                        swipeFenzhen.setRefreshing(false);
                        adapter.notifyDataSetChanged();
                    ...
                    case 4:
                        swipeFenzhen.setRefreshing(false);
                        ToastUtils.s(ActivityXGBL.this, msg);
                        Intent intent = new Intent(ActivityXGBL.this, LoginActivity.class);
        ...
        adapter.setOnItemClickListener(new XGYZdapter.OnRecyclerViewItemClickListener() {
            ...
            public void onClick(View view, XGYZdapter.ViewName viewName, int position) {
                if (viewName== XGYZdapter.ViewName.ITEM){
                    Intent intent=new Intent(ActivityXGBL.this,ActivityXGYZDetails.class);
