...
import com.gxey.remotemedicalplatform.adapter.HealthNewsAdapter;
import com.gxey.remotemedicalplatform.adapter.HealthNewsAdapter;
...
public class ActivityHealthNews extends BaseActivity implements View.OnClickListener {
    ...
    protected void initView() {
        ...
        toolbarMid.setText("健康头条");
        setSupportActionBar(toolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        ScreenUtils.setStatusBarLightMode(ActivityHealthNews.this, R.color.black);
        list = new ArrayList<>();
        initLoad();
    ...
    private void initLoad(){
        ...
        emptyLayoutYichuan.setOnButtonClick(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                emptyLayoutYichuan.showLoading(ActivityHealthNews.this);
                //重新加载数据
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
    ...
    private void getZCNews(String PageIndex) {
        ...
        HttpClientHelper.getInstance().GetNews(ZCType, PageIndex, ZCPageSize, new HttpSubseiber.ResponseHandler<List<HomeNewsBen>>() {
            ...
            public void onSucceed(List<HomeNewsBen> data) {
                ...
                list = data;
                recyclerViewYichuan.setAdapter(adapter = new HealthNewsAdapter(ActivityHealthNews.this, list));
                adapter.changeMoreStatus(adapter.NO_LOAD_MORE);
                adapter.notifyDataSetChanged();
                adapter.setOnItemClickListener(new HealthNewsAdapter.OnRecyclerViewItemClickListener() {
                    @Override
                    public void onClick(View view, HealthNewsAdapter.ViewName viewName, int position) {
                        Intent intent = new Intent(ActivityHealthNews.this, WebBannerbenActgvity.class);
            ...
            public void onFail(String msg) {
                ...
                ToastUtils.s(ActivityHealthNews.this, msg);
            }
        });
    }
